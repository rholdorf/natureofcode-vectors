...
namespace Noise
{
    ...
    {
        private const int P_SIZE = 2048;
        private const int P_MASK = 2047;
        ...
        {
            _perm = new short[P_SIZE];
            _permGrad2 = new Grad2[P_SIZE];
            _permGrad3 = new Grad3[P_SIZE];
            _permGrad4 = new Grad4[P_SIZE];
            var source = new short[P_SIZE];
            for (short i = 0; i < P_SIZE; i++)
                source[i] = i;
            for (var i = P_SIZE - 1; i >= 0; i--)
            {
        ...
        private double Noise2_Base(double xs, double ys)
        {
            ...
            for (var i = 0; i < 4; i++)
            {
                ...
                if (attn <= 0) continue;
                int pxm = (xsb + c.Xsv) & P_MASK, pym = (ysb + c.Ysv) & P_MASK;
        ...
        private double Noise3_BCC(double xr, double yr, double zr)
        {
            ...
            while (c != null)
            {
                ...
                {
                    int pxm = (xrb + c.Xrv) & P_MASK, pym = (yrb + c.Yrv) & P_MASK, pzm = (zrb + c.Zrv) & P_MASK;
        ...
        private double Noise4_Base(double xs, double ys, double zs, double ws)
        {
            ...
            foreach (var c in Lookup4D[index])
            {
                ...
                if (attn > 0)
                {
                    ...
                    int pxm = (xsb + c.Xsv) & P_MASK, pym = (ysb + c.Ysv) & P_MASK;
                    int pzm = (zsb + c.Zsv) & P_MASK, pwm = (wsb + c.Wsv) & P_MASK;
        ...
        static OpenSimplex2S()
        {
            ...
            for (var i = 0; i < 8; i++)
            {
                ...
                LatticePoint3D c3 = new(i1, j1 ^ 1, k1 ^ 1, 0);

                // (1, 0, 0) vs (0, 1, 1) away from octant, on second half-lattice.
                LatticePoint3D c4 = new(i1 + (i2 ^ 1), j1 + j2, k1 + k2, 1);
                LatticePoint3D c5 = new(i1 + i2, j1 + (j2 ^ 1), k1 + (k2 ^ 1), 1);

                // (0, 1, 0) vs (1, 0, 1) away from octant.
                LatticePoint3D c6 = new(i1, j1 ^ 1, k1, 0);
                LatticePoint3D c7 = new(i1 ^ 1, j1, k1 ^ 1, 0);

                // (0, 1, 0) vs (1, 0, 1) away from octant, on second half-lattice.
                LatticePoint3D c8 = new(i1 + i2, j1 + (j2 ^ 1), k1 + k2, 1);
                LatticePoint3D c9 = new(i1 + (i2 ^ 1), j1 + j2, k1 + (k2 ^ 1), 1);

                // (0, 0, 1) vs (1, 1, 0) away from octant.
                LatticePoint3D cA = new(i1, j1, k1 ^ 1, 0);
                LatticePoint3D cB = new(i1 ^ 1, j1 ^ 1, k1, 0);

                // (0, 0, 1) vs (1, 1, 0) away from octant, on second half-lattice.
                LatticePoint3D cC = new(i1 + i2, j1 + j2, k1 + (k2 ^ 1), 1);
                LatticePoint3D cD = new(i1 + (i2 ^ 1), j1 + (j2 ^ 1), k1 + k2, 1);
            ...
            Gradients2D = new Grad2[P_SIZE];
            Grad2[] grad2 = {
                new( 0.130526192220052,  0.99144486137381),
                new( 0.38268343236509,   0.923879532511287),
                new( 0.608761429008721,  0.793353340291235),
                new( 0.793353340291235,  0.608761429008721),
                new( 0.923879532511287,  0.38268343236509),
                new( 0.99144486137381,   0.130526192220051),
                new( 0.99144486137381,  -0.130526192220051),
                new( 0.923879532511287, -0.38268343236509),
                new( 0.793353340291235, -0.60876142900872),
                new( 0.608761429008721, -0.793353340291235),
                new( 0.38268343236509,  -0.923879532511287),
                new( 0.130526192220052, -0.99144486137381),
                new(-0.130526192220052, -0.99144486137381),
                ...
